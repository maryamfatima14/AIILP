...
export default function StudentNotifications() {
  ...
  // Student/guest should only see application_status notifications
    ...
    <div className="space-y-6">
      ...
      <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-4">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-blue-600">Notifications</h1>
        ...
        <div className="divide-y divide-gray-100">
          {!filteredNotifications || filteredNotifications.length === 0 ? (
            <div className="p-16 text-center">
              ...
              <p className="text-gray-500 max-w-sm mx-auto">You're all caught up! No new notifications at the moment.</p>
            </div>
          ) : (
